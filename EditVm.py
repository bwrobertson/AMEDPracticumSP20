...
class Ui_EditVM(object):
    def setupUi(self, EditVM):
        ...
        self.manageExploitsBUTTON = QtWidgets.QPushButton(self.widget)
        self.manageExploitsBUTTON.setObjectName("manageExploitsBUTTON")
        self.vmFilesAddToVMBUTTON = QtWidgets.QPushButton(self.widget)
        ...
        self.setupTree(EditVM) ###Method Call
